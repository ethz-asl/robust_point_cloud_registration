#ifndef PROB_POINT_CLOUD_REGISTRATION_WEIGHT_UPDATER_CALLBACK_H
#define PROB_POINT_CLOUD_REGISTRATION_WEIGHT_UPDATER_CALLBACK_H
...
public:
    ...
    ceres::CallbackReturnType operator()(const ceres::IterationSummary &summary)
    {
        ...
        VLOG(1) << "data_association_->cols() = "
                << data_association_->cols();
        VLOG(1) << "params_->max_neighbours="
